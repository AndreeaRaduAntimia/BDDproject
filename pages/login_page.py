...
class Login_page(Base_page):
    ...
    FORGOT_YOUR_PASSWORD = (By.CSS_SELECTOR, 'div.orangehrm-login-forgot')
    ...
    def click_forgot_your_pass(self):
        self.chrome.find_element(*self.FORGOT_YOUR_PASSWORD).click()

    def check_current_url(self, expected_url):
        actual_url = self.chrome.current_url
        expected_url = expected_url
        assert expected_url in actual_url, "The url is incorrect. Please check the login functionality"
